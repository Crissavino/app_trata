...
<body>
    <section class="container">
    	...
    	<form class="formulario" action="" method="POST" accept-charset="utf-8" style="display: none;">
    		@method('POST')
    		@csrf
    		<input type="" name="bformulario_id">
    		<input type="" name="lat">
    		<input type="" name="long">
    	</form>
    </section>
   ...
   {{--  <script>
    ...
    <script src="/js/heatmap.js" type="text/javascript" charset="utf-8" async defer></script>
    <script src="/js/leaflet-heatmap.js" type="text/javascript" charset="utf-8" async defer></script>
    <script src="https://unpkg.com/leaflet@1.4.0/dist/leaflet.js" integrity="sha512-QVftwZFqvtRNi0ZyCtsznlKSWOStnDORoefr1enyq5mVL4tmKB3S/EnC3rRJcxCPavG10IcrVGSmPh6Qw5lwrg==" crossorigin=""></script>
    <script src="/js/mapas.js" type="text/javascript" charset="utf-8" async defer></script>
</body>
</html>
