...
<header>
    ...
    <ul class="nav nav-tabs">
        ...
        @endif
        @if ($idFormD)
            <li class="nav-item"> <a class="nav-link active" href="/formularios/edicion/D/{{ $idFormD }}">Eje D: Datos de delito</a> </li>
        @else
            <li class="nav-item"> <a class="nav-link active" href="/formularios/D">Eje D: Datos de delito</a> </li>
        @endif
        {{-- @if ($idFormE)
