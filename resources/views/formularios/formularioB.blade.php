            ...
            @if ( $tipoVictima !== 1 )
                ...
                <!-- QUINTA PREGUNTA -->
                    <div class="form-group {{ $errors->has('tipodocumento_id') ? 'has-error' : ''}}" id="tipodoc">
                        ...
                        <div class="tipoDocumentoOtro" style="display: none" {{ $errors->has('victima_tipo_documento_otro') ? 'has-error' : ''}}>
                            ...
                            <input name="victima_tipo_documento_otro" id="victima_tipo_documento_otro" value="{{old('victima_tipo_documento_otro')}}" id="victima_tipo_documento_otro" class="form-control" type="text">
                        </div>
                ...
                <!-- DECIMA PREGUNTA -->
                    <div class="form-group {{ $errors->has('victima_fecha_nacimiento') ? 'has-error' : ''}}">
                        ...
                        <input type="date" class="form-control date" id="victima_fecha_nacimiento" name="victima_fecha_nacimiento" value="{{old('victima_fecha_nacimiento')}}" >
                    ...
                    <div class="form-group {{ $errors->has('vicindirecta_id') ? 'has-error' : ''}}">
                        ...
                        <select class="selectVictimasIndirectas form-control" name="vicindirecta_id" id="vicindirecta_id">
                            ...
                            @foreach ($datosVictimaIndirecta as $vicIndirecta)
                                <option value="{{$vicIndirecta->id}}" {{ old('vicindirecta_id') == $vicIndirecta->id ? 'selected' : '' }}>{{$vicIndirecta->nombre}}</option>
                            @endforeach
                        </select>
