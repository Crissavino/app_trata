...
<header>
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item active"> <a class="nav-link active" href="/formularios/buscadorFiscalia">Buscador por fiscalía/juzgado interviniente</a> </li>
...
<body>
    ...
    <section class="container">
        <h1 class="text-center" style="padding: 15px;">
            Buscador por fiscalía/juzgado interviniente
        </h1>

        <form action="/formularios/buscadorFiscalia" class="navbar-form" method="get" accept-charset="utf-8">
            {{ csrf_field() }}
            <div class="form-group">
                <div class="input-group mb-2 mr-sm-2">
                    ...
                    <input type="text" class="form-control form-control-lg" id="inlineFormInputGroupUsername2" placeholder="Fiscalía/Juzgado interviniente" name="fiscaliaJuzgado">
                </div>
            </div> 
        </form>
        ...
        <div class="mt-5 busqueda-formA">
            <table class="mb-5 table table-hover table-striped">
                <thead>
                    <h2>Resultado busqueda por fiscalía/juzgado interviniente</h2>
                </thead>
                <tbody>
                    <tr class="encabezado">
                        <th class="w-20">Número de carpeta</th>
                        <th class="w-20">Fiscalía/Juzgado Interviniente</th>
                        <th class="w-20"></th>
                        <th class="w-20"></th>
                    </tr>
