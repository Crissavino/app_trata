...
<body>
    ...
    <section class="container">
        ...
        <div class="ml-3">
            ...
            <label for="">N&uacute;mero de carpeta:</label>
                        ...
                        @if ($modalidad->id == 3)
                            @foreach ($arrayFormA['datosPresentacion'] as $presentacion)
                                @if ($formA->presentacion_espontanea_id == $presentacion->id)
                                    <label for="">Presentaci&oacute;n espontanea:</label>
                        ...
                        @if ($modalidad->id == 5)
                            @foreach ($arrayFormA['datosOrganismo'] as $organismo)
                                @if ($formA->derivacion_otro_organismo_id == $organismo->id)
                                    <label for="">Derivaci&oacute;n de otro organismo:</label>
                                    {{ $organismo->nombre }}<br>
                                    @if ($organismo->id == 16)
                                        <label for="">Derivaci&oacute;n de que otro organismo:</label>    
            ...
            <div>
                @foreach ($arrayFormA['datosAmbito'] as $ambito)
                    @if ($formA->ambito_id == $ambito->id)
                        <label for="">&aacute;mbito de competencia:</label>
                        {{ $ambito->nombre }}<br>
                        @if ($ambito->id == 2)
            ...
            <label for="">Fiscal&iacute;a/Juzgado Interviniente:</label>
            ...
            <div>
                @foreach ($arrayFormA['datosCaratulacion'] as $caratulacion)
                    @if ($formA->caratulacionjudicial_id == $caratulacion->id)
                        <label for="">Caratulaci&oacute;n Judicial:</label>
                        {{ $caratulacion->nombre }}<br>
                        @if ($caratulacion->id == 7)
                            <label for="">Tipo de Caratulaci&oacute;n Judicial:</label>
                ...
                @foreach ($formA->profesionalintervinientes as $prof)
                    ...
                    {{-- @dd($profesional) --}}
                        @if ($prof->profesional_id == $profesional->id)
                            <label for="">Nombre/Equipo/Profesi&oacute;n:</label>
        ...
        <h3 class="text-left" style="padding: 15px;">Caracterizaci&oacute;n de la victima</h3>
        @if ($formB !== null)
            <div class="ml-3">
                <!-- PRIMERA PREGUNTA -->
                ...
                <!-- CUARTA PREGUNTA -->
                        <label for="">¿Cuenta con alguna documentaci&oacute;n que permita acreditar su identidad?:</label>
                ...
                <!-- QUINTA PREGUNTA -->
                    <label for="">Tipo de documentaci&oacute;n:</label>
                ...
                {{-- PAIS DE NACIMIENTO --}}
                    <label for="">Pa&iacute;s de Nacimiento: </label>
                ...
                <!-- DECIMASEPTIMA PREGUNTA -->
                        <label for="">¿Presenta alg&uacute;n tipo de discapacidad?</label>
                ...
                <!-- DECIMAOCTAVA PREGUNTA -->
                    ...
                    @foreach ($arrayFormB['datosLesionConstatada'] as $constatada)
                        @if ($constatada->id == $formB->lesionconstatada_id)
                            <label class="">¿Fue constatado en el momento por alg&uacute;n profesional de la salud? :</label>
                            {{$constatada->nombre}}<br>
                            @if ($formB->lesionconstatada_id == 1)
                                <label class="">¿A qu&eacute; organismo pertenece el profesional de la salud?:</label>
                ...
                <!-- DECIMANOVENA PREGUNTA -->
                    <label for="">¿Tiene enfermedades cr&oacute;nicas?:</label>
                    @foreach ($arrayFormB['datoEnfermedadCronica'] as $enfermedad)
                        @if ($enfermedad->id == $formB->enfermedadcronica_id)
                            ...
                            @if ($formB->enfermedadcronica_id == 1)
                                <label class="">Tipo de enfermedad cr&oacute;nica:</label>
                ...
                <!-- VIGESIMA PREGUNTA -->
                    <label>¿Presenta alg&uacute;n tipo de limitaci&oacute;n para comunicarse? </label>
                ...
                <!-- VIGESIMAPRIMERA PREGUNTA -->
                    <br><label for="">M&aacute;ximo nivel educativo alcanzado:</label>
                ...
                <!-- VIGESIMASEGUNDA PREGUNTA -->
                    <label for="">¿Cuenta con alg&uacute;n oficio adquirido o de inter&eacute;s?: </label>
                ...
                <div class="form-group">
                    ...
                    @foreach ($arrayFormC['referentes'] as $referente)
                        <div>
                            ...
                            <label for="">Referente - Tipo de v&iacute;nculo con la v&iacute;ctima:</label>
                            @foreach ($arrayFormC['datosVinculos'] as $vinculo)
                                @if ($vinculo->id == $referente->vinculo_id)
                                    {{ $vinculo->nombre }}<br>
                                    @if ($vinculo->id == 6)
                                        <label for="">Cu&aacute;l?</label>
        ...
        @if ($formD !== null)
            <div class="ml-3">
                <label for="">Calificaci&oacute;n general: </label>
                ...
                <label for="">Calificaci&oacute;n espec&iacute;fica: </label>
                    ...
                    @if ($formD->actividad_id == $actividad->id)
                        ...
                        @if ($actividad->id == 1 || $actividad->id == 2)
                            ...
                            @foreach ($formD->rurals as $rural)
                                {{$rural->nombre}}
                                @if ($rural->id == 6)
                                    <br><label for="">Cu&aacute;l?</label>
                                    {{$formD->rural_otra}}<br>
                                @endif
                            @endforeach
                ...
                <label for="">País de captaci&oacute;n:</label>
                {{ $formD->paisCaptacion }}<br>

                <label for="">Provincia de captaci&oacute;n:</label>
                {{ $formD->provinciaCaptacion }}<br>

                <label for="">Localidad de captaci&oacute;n:</label>
                ...
                @foreach ($arrayFormD['datosContactoExplotacion'] as $contactoExplotacion)
                    @if ($formD->contactoexplotacion_id == $contactoExplotacion->id)
                        <label for="">Modo de contacto con lugar de explotaci&oacute;n:</label>
                ...
                <label for="">País de explotaci&oacute;n:</label>
                {{ $formD->paisExplotacion }}<br>

                <label for="">Provincia de explotaci&oacute;n:</label>
                {{ $formD->provinciaExplotacion }}<br>

                <label for="">Localidad de explotaci&oacute;n:</label>
                {{ $formD->ciudadExplotacion }}<br>

                <label for="">Domicilio de explotaci&oacute;n:</label>
                {{ $formD->domicilio }}<br>

                <label for="">¿Pas&oacute; por otros lugares de explotaci&oacute;n previamente?</label>
                @foreach ($arrayFormD['datosLugarExplotacion'] as $lugarExplotacion)
                    @if ($formD->otrolugarexplotacion_id == $lugarExplotacion->id)
                        ...
                        @if ($lugarExplotacion->id == 1)
                            <label for="">Cu&aacute;l/es?</label>
                            {{ $formD->lugarexplotacionCual }}<br>
                        @endif
                    @endif
                @endforeach

                <label for="">Reside en el lugar de explotaci&oacute;n u otro espacio perteneciente a los tratantes?</label>
                ...
                <label for="">¿Se encontraban otras personas en situaci&oacute;n de explotaci&oacute;n en el mismo espacio?</label>
                ...
                <label for="">Tiempo de permanencia en situaci&oacute;n de explotaci&oacute;n:</label>
                ...
                <label for="">¿El lugar de explotaci&oacute;n cuenta con corriente eléctrica?:</label>
                ...
                <label for="">¿El lugar de explotaci&oacute;n cuenta con gas?:</label>
                ...
                <label for="">¿Se presentan condiciones de hacinamiento en el lugar de explotaci&oacute;n?:</label>
                ...
                <label for="">¿El lugar de explotaci&oacute;n posee agua potable?:</label>
                ...
                <label for="">El lugar de explotaci&oacute;n posee:</label>
                ...
                <label for="">¿El lugar de explotaci&oacute;n cuenta con una cantidad de baños suficientes?:</label>
                ...
                <label for="">Material de contrucci&oacute;n predominante en las paredes del lugar de explotaci&oacute;n:</label>
                ...
                <label for="">Provisi&oacute;n de elementos de trabajo por parte del explotador:</label>
                ...
                <label for="">Provisi&oacute;n de elementos de seguridad por parte del explotador:</label>
        ...
        <h3 class="text-left" style="padding: 15px;">Atenci&oacute;n del caso</h3>
        @if ($formF !== null)
            <div class="ml-3">
                        ...
                        @foreach ($arrayFormF['aFormularios'] as $aFormulario)
                            @if ($aFormulario->datos_numero_carpeta == $formF->numeroCarpeta)
                                ...
                                @if($aFormulario->derivacion_otro_organismo_id == null)
                                    {{-- <input type="text" name="" class="form-control ml-3" readonly="readonly" value="No intervino ning&uacute;n organismo previamente"> --}}
                                @endif
                                ...
                                @if ($aFormulario->derivacion_otro_organismo_id !== 16)
                                    ...
                                    @if (count($formF->policias) !== 0)
                                        <br><label for="">Polic&iacute;a:</label>
        ...
        <h3 class="text-left" style="padding: 15px;">Detalle de intervenci&oacute;n</h3>
        @if ($formG !== null)
           <div class="ml-3">
                ...
                <div>
                    ...
                    @foreach ($arrayFormG['intervenciones'] as $intervencion)
                        ...
                        <div>
                            ...
                            <label for="">Tel&eacute;fono de contacto:</label>
                            {{ $intervencion->telefonoContacto }}<br>
                            <label for="">Descripci&oacute;n de la intervenci&oacute;n:</label>
