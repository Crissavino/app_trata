...
<head>
    ...
    <title>Buscador por número de causa</title>
    <style>
        .encabezado{
            color: blue;
            font-size: 20px;
...
<header>
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item active"> <a class="nav-link active" href="/formularios/buscadorNumero">Buscador por número de causa</a> </li>
...
<body>
    ...
    <section class="container">
        <h1 class="text-center" style="padding: 15px;">
            Buscador por número de causa judicial
        </h1>

        <form action="/formularios/buscadorNumero" class="navbar-form" method="get" accept-charset="utf-8">
            {{ csrf_field() }}
        ...
        <div class="mt-5 busqueda-formA">
            <table class="mb-5 table table-hover table-striped">
                <thead>
                    <h2>Resultado busqueda por número de causa judicial</h2>
                </thead>
                <tbody>
                    <tr class="encabezado">
