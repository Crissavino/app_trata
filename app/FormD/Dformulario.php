...
class Dformulario extends Model
{
    ...
    protected $fillable = ['calificaciongeneral_id', 'calificaciongeneral_otra', 'calificacionespecifica_id', 'finalidad_id', 'finalidad_otra', 'actividad_id', 'actividad_otra', 'privado_otra', 'domicilioVenta', 'rural_otra', 'marcaTextil', 'textil_otra', 'contactoexplotacion_id', 'contactoexplotacion_otro', 'viajo_id', 'acompanado_id', 'acompanadored_id', 'domicilio', 'residelugar_id', 'engano_id', 'haypersona_id', 'tipovictima_id', 'tarea', 'horasTarea', 'frecuenciapago_id', 'modalidadpagos_id', 'especiaconceptos_otro', 'montoPago', 'deuda_id', 'lugardeuda_id', 'motivodeuda_otro', 'permanencia_id', 'testigo_id', 'coordinadorPTN', 'coordinadorPTN_otro', 'haycorriente_id', 'haygas_id', 'haymedidas_otro', 'hayhacinamiento_id', 'hayagua_id', 'haybano_id', 'cuantosbano_id', 'material_id', 'material_otro', 'elementotrabajo_id', 'elementoseguridad_id'];
