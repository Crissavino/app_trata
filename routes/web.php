...
//RUTAS FORMULARIO A
Route::get('formularios/A', 'FormsController@createA')->middleware('auth', 'faltaCompletarEje');
...
//RUTAS FORMULARIO D
Route::get('formularios/D', 'FormsController@createD')->middleware('auth', 'noHayCarpeta', 'noHayEjeA', 'noHayEjeB', 'noHayEjeC');
